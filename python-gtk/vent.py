...
class Mi_Ventana(Gtk.Window):
	...
	def agregar_boton(self):	
		self.boton_1 = Gtk.Button('Resaltar texto escrito')
		self.boton_1.connect('clicked', self.Imprimir)
	...
	def agregar_salida(self):	
		self.botonexit = Gtk.Button('Finalizar')
		self.botonexit.connect('clicked', Gtk.main_quit)

	def contenedor(self):	
		self.box = Gtk.VBox()
		self.box.pack_start(self.texto, True, False, 0)
		self.box.pack_start(self.boton_1, True, False, 0)
		self.box.pack_start(self.label_1, True, False, 0)
		self.box.pack_start(self.botonexit, True, False, 0)
		self.add(self.box)
